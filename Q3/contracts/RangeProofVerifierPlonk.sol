...
contract RangeProofVerifierPlonk {
    
    uint32 constant n =   64;
    uint16 constant nPublic =  1;
    uint16 constant nLagrange = 1;
    
    uint256 constant Qmx = 18883776538678919579938860441071947091066187211922212571886140832236997485867;
    uint256 constant Qmy = 13202680502890733371712893902747591345162598194207848511496240808250057969549;
    uint256 constant Qlx = 7810983367652128784338782092929270388653446123103100139454611871596445765292;
    uint256 constant Qly = 19344124828273544583892040760919350368513891616447126480150228909121603481459;
    uint256 constant Qrx = 19747272460354567194246688999116399572961068534572607572794349910302129426763;
    uint256 constant Qry = 20378748218533557459120228177826030445433593847856822874344795339181594356150;
    uint256 constant Qox = 6922922299183384885147371928546933371838766105547318739179773861921660303260;
    uint256 constant Qoy = 875706505419495609970236032268435371032794989510510844468060622489541549353;
    uint256 constant Qcx = 4263750179836304390841765047819652721031798212465897090607694076465913130942;
    uint256 constant Qcy = 4449508936787534025057695476243959282310403724921320207169555923259595288441;
    uint256 constant S1x = 15353012401788964835546028896854723729929632004645262149458101415152602750279;
    uint256 constant S1y = 17317551343992623920487198586506082082042319811370923605347751946209841717743;
    uint256 constant S2x = 2225254220696536699048200534304106207126690477538420303440433442761922209106;
    uint256 constant S2y = 6298789336246947952780169954059957279811118692632547854537167565666460681061;
    uint256 constant S3x = 13176861523958313164877383484166217265442558460281476736858701458186639039040;
    uint256 constant S3y = 11814745171191769944672737728718286808738747167088492245561535145784060752347;
